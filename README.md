...
👉 [View on Tableau Public](https://public.tableau.com/views/HRAnalyticsPredictiveModelforEmployeeAttrition/Dashboard1)
...
### Model Performance
| Model | Accuracy | Recall (Attrition=Yes) |
|---|---|---|
| Random Forest | 88% | 0.13 |
| Random Forest + SMOTE | 85% | 0.26 |
...
👉 [Ver en Tableau Public](https://public.tableau.com/views/HRAnalyticsPredictiveModelforEmployeeAttrition/Dashboard1)
...
| Modelo | Accuracy | Recall (Deserción=Sí) |
|---|---|---|
| Random Forest | 88% | 0.13 |
| Random Forest + SMOTE | 85% | 0.26 |
